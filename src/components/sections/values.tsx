...
export function Values() {
  return (
    <section id="values" className="bg-[#F7F5F2] py-16 md:py-24 lg:py-40 relative overflow-hidden scroll-mt-24">
      <SectionOverlay variant="right" />
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 md:px-16 xl:px-24">
        <Reveal>
          <h2 className="font-[family-name:var(--font-playfair)] text-[clamp(2.2rem,3.5vw,3rem)] font-bold text-[#1A1A1A] leading-[1.1] mb-10 md:mb-20">
            ...
            <Reveal key={i} delay={i * 0.12}>
              <div
                className={`p-8 md:p-10 bg-white rounded-sm shadow-md
                  ...
                  group cursor-default relative overflow-hidden${i % 2 === 1 ? " md:mt-10" : ""}`}
                style={{
